...
import { LayoutDashboard, ShoppingBag, ShoppingCart, User, Sparkles, Heart } from "lucide-react";
...
const customerMenuItems = [
  ...
  { href: "/dashboard/customer/recommendations", label: "AI Recommendations", icon: Sparkles },
